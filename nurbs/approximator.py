...
# show the diagram for the filter only once at the beginning
diagram = False


def runfilt(t, xn, degree=2, lowfilt=0.005):
    '''signal filter for PointCloudApprox'''
...
# Approximation of a point cloud by a curve
#
#
...
#        obj.addProperty("App::PropertyInteger","discretizeCount").discretizeCount=30
    ...
    def runPountCloudApprox(self, obj, bo=None):
        ...
        for l in [0]:  # number of runs
            ...
            if obj.closed:  # adjust cyclic ends
                sx = x[0]
                ex = x[-1]
...
def createPointCloudApprox():
    '''method is called from the smoothPointcloud dialog'''
...
class Nurbs_smoothPointcloudGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_smoothPointcloudGUI"),
...
class myApp(MikiApp):
    # temp. test data for the image widget
    index = 0
...
class Nurbs_loadPointcloudfromImageGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_loadPointcloudfromImageGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class ImagePoints2(FeaturePython):
    ...
    def execute(self, obj):
        ...
        if obj.mode == 'face':  # bump on free-form surface
...
class Nurbs_LoadCylinderfacefromImageGUI:
    ...
    def _loadCylinderfacefromImageGUI(self):
        ...
        ImagePoints2(yy)
        yy.mode = 'cylinder'
        fn = NURBSinit.IMAGES_PATH+'2364.png'
        yy.image = fn
        ViewProvider(yy.ViewObject)
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_LoadCylinderfacefromImageGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_BumpFacefromImageGUI:
    ...
    def _BumpFacefromImageGUI(self):
        ...
        fn = NURBSinit.IMAGES_PATH+"profil_for_bump.png"
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_BumpFacefromImageGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
#            print ("result", dd,fp.Proxy.loops)
            return dd
...
#                dd2 += (bc.value(bc.parameter(ptsa[3*z]))-ptsa[3*z]).Length**2*kk
            ...
            if fp.Proxy.loops % 20 == 0:
                Gui.updateGui()
#                print ("result", dd2,fp.Proxy.loops)
            return (dd/nn)**0.5
...
# --------end run with soft----------------------
    ...
    def onChanged(self, fp, prop):
        ...
        if prop in ["factor", 'method', 'alphaStart', 'alphaEnd', 'betaEnd', 'betaStart', 'factorList', 'tangentModel'] or prop.startswith('_'):
            ...
            # if there is a curve, then take poles
            try:  # if it's a curve
...
class Nurbs_minimumLengthBezier:
    ...
    def _minimumLengthBezierGUI(self):
        '''find the optimal curve with two segments through a point'''
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_minimumLengthBezier"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_CreateMyMinAGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateMyMinAGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createMyMinSoftGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createMyMinSoftGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_nearconstantCurvatureBezier:
    ...
    def _nearconstantCurvatureBezierGUI(self):
        '''Optimal curve with minimal change in curvature'''
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_nearconstantCurvatureBezier"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createBezierPolesFramefromribsGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createBezierPolesFramefromribsGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
def swapCurves(sel=None, mode='polygons', extraknots=None):
    '''pull up the pole field in the other direction'''
...
def curvestoFace(polsarr=None, mode="Bezier Face"):
    ...
    try:
        ...
        print("Problems with dot matrix segments not of the same length -- cancellation")
        return
    print("huhuhu")
#    a,b=b,a
...
class Nurbs_DontKnowWhatThisDo_B:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_DontKnowWhatThisDo_B"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_RibstoFace:
    def Activated(self):
        self.RibstoFace()
    def RibstoFace(self):
        '''swap, reshape in bezier, make m area'''
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_RibstoFace"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
#
#  tools for refining surfaces ...
#

def findrib():
    # find point on curve with given x and make a pole there
...
def usage(msg=""):
    if msg != "": msg = "\n"+msg+"\n"
    errorDialog("Error in " + inspect.stack()[1][1].split('/')[-1]+" line:"+str(inspect.stack()[1][2]) +
...
def AA():
    '''Generate to three hard coded lengths and angles
a settlement. The idea is to create a surface that
can be glued to a free-form surface.
    '''
...
#    except:
#        usage("only works if there is a cone")
