...
class Nurbs_smoothSMOOTHMESH:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_smoothSMOOTHMESH"),
...
class Nurbs_smoothSplitMESH:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_smoothSplitMESH"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
...
class Nurbs_smoothSliceMeshBySketch:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_smoothSliceMeshBySketch"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
...
class Nurbs_smothDistanceCurves:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_smothDistanceCurves"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
