...
class Nurbs_CreateOrUpdateSoleEnvironmentSheet:
    ...
    def Activated(self):
        ...
        try:
            ...
            ss = App.ActiveDocument.addObject(
        ...
        if model != None:
            ...
            tt = np.array(
                [ssa2npa(ss, 2, 19, 8, 21, default=None).swapaxes(0, 1)])
    ...
    #            print ("XX",i,tt)
                ...
                pts2 += [[[x, weib[i]+1.0*(weia[i]-weib[i])*j/6, h]
                          for j in range(7)]]
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'drawing.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateOrUpdateSoleEnvironmentSheet"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs  Nurbs_CreateOrUpdateSoleEnvironmentSheet", _tooltip)}

Gui.addCommand("Nurbs_CreateOrUpdateSoleEnvironmentSheet",
...
class Nurbs_PrototypeCreateHELL:
    def Activated(self):
        ...
        points = [App.Vector(165., -7., -00.0), App.Vector(208., -
                                                        25., -00.0), App.Vector(233., 20., -00.0)]
        spline = Draft.makeBSpline(points, closed=True, face=True, support=None)
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'drawing.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_PrototypeCreateHELL"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs  Nurbs_PrototypeCreateHELL", _tooltip)}

Gui.addCommand("Nurbs_PrototypeCreateHELL",
