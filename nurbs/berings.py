...
class Bering(FeaturePython):
    ...
    def __init__(self, obj):
        ...
        obj.preScale=App.Vector(100,100,100)
        obj.postScale=App.Vector(100,100,100)
        obj.vScale=App.Vector(100,100,100)
...
#        ass=App.ActiveDocument.addObject("Part::Feature","name")
...
def genA():
    ...
    sks += [genk(start,end,1,App.Vector(),source)]
    sks += [genk(start,end,1.9,App.Vector(200,0,0),source)]
    sks += [genk(start,end,0.9,App.Vector(400,0,100),source)]
...
def genB():
    ...
    sks += [genk(start,end,1,App.Vector(),source)]
    sks += [genk(start,end,0.9,App.Vector(0,0,80),source)]

    sks += [genk(start,end,0.5,App.Vector(0,0,200),source)]
    sks += [genk(start,end,0.5,App.Vector(0,0,240),source)]
    sks += [genk(start,end,0.5,App.Vector(0,0,280),source)]

    sks += [genk(start,end,0.6,App.Vector(0,0,600),source)]
    sks += [genk(start,end,0.6,App.Vector(0,0,650),source)]
    sks += [genk(start,end,0.6,App.Vector(0,0,690),source)]

    sks += [genk(start,end,0.64,App.Vector(0,0,800),source)]
    sks += [genk(start,end,0.64,App.Vector(0,0,850),source)]
    sks += [genk(start,end,0.64,App.Vector(0,0,890),source)]

    sks += [genk(start,end,1.1,App.Vector(0,0,1340),source)]
    sks += [genk(start,end,1.0,App.Vector(0,0,1440),source)]
...
class Nurbs_TestCaseBeringTest:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_TestCaseBeringTest"),
...
#
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_FixCorner"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createProduct:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createProduct"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createProduct", Nurbs_createProduct())
...
#    print ("debugP deaktiviert";return
    ...
    obj.Shape=Part.makePolygon([App.Vector()]+pts)
...
class Nurbs_CreateSeam:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateSeam"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_CreateSeam", Nurbs_CreateSeam())




class Nurbs_createDatumPlane:
    def Activated(self):
        self.createDatumPlane()
    
    def createDatumPlane(self):
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createDatumPlane"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createDatumPlane", Nurbs_createDatumPlane())



class Nurbs_createDatumLine:
    def Activated(self):
        self.createDatumLine()
    def createDatumLine(self):
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createDatumLine"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createDatumLine", Nurbs_createDatumLine())
...
def begrid(bs,showTangents=True,showKnotCurves=True):
        ...
        if showKnotCurves:
            ...
            for u in range(nu):
                for v in range(nv):
                    try:
                        comps += [Part.makePolygon([App.Vector(poles[3*u,3*v]),App.Vector(poles[3*u,3*v+1])])]
                        comps += [Part.makePolygon([App.Vector(poles[3*u,3*v]),App.Vector(poles[3*u+1,3*v])])]
                        if u>0:
                            comps += [Part.makePolygon([App.Vector(poles[3*u-1,3*v]),App.Vector(poles[3*u,3*v])])]
                        if v>0:
                            comps += [Part.makePolygon([App.Vector(poles[3*u,3*v-1]),App.Vector(poles[3*u,3*v])])]
                    except: pass
            for u in range(nu):
                try:
                    v=vc-1
                    comps += [Part.makePolygon([App.Vector(poles[3*u,v]),App.Vector(poles[3*u+1,v])])]
                    comps += [Part.makePolygon([App.Vector(poles[3*u,v-1]),App.Vector(poles[3*u,v])])]
                    if u>0:
                        comps += [Part.makePolygon([App.Vector(poles[3*u-1,v]),App.Vector(poles[3*u,v])])]
                except:
                    pass
            for v in range(nv):
                try:
                    u=uc-1
                    comps += [Part.makePolygon([App.Vector(poles[u,3*v]),App.Vector(poles[u,3*v+1])])]
                    comps += [Part.makePolygon([App.Vector(poles[u,3*v]),App.Vector(poles[u-1,3*v])])]
                    if v>0:
                        comps += [Part.makePolygon([App.Vector(poles[u,3*v]),App.Vector(poles[u,3*v-1])])]
                except:
                    pass
            try:
                u=uc-1
                v=vc-1
                comps += [Part.makePolygon([App.Vector(poles[u,v]),App.Vector(poles[u,v-1])])]
                comps += [Part.makePolygon([App.Vector(poles[u,v]),App.Vector(poles[u-1,v])])]
            except:
                pass
...
## create a BeGrid object for the selected objects'''
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateBeGrid"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_BSplineToBezierCurve1:
    def Activated(self):
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_BSplineToBezierCurve1"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_BSplineToBezierCurve2:
    ...
    def GetResources(self):    
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_BSplineToBezierCurve2"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
## create a Bezier Surface for a selectde BSpline Surface
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_BSplineToBezierSurface"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_SurfaceEDITOR:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'surfaceEditor.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_SurfaceEDITOR"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_connectFaces:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_connectFaces"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_connectFaces", Nurbs_connectFaces())
...
class Nurbs_CreateBEplane:
    def Activated(self):
        self.createBePlane()

    def createBePlane(self):
    ...
    def GetResources(self):
        ...
        _tooltip = ("")
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateBEplane"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_CreateBEplane", Nurbs_CreateBEplane())
...
class Nurbs_CreateBETube:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateBETube"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_CreateBETube", Nurbs_CreateBETube())
...
class Nurbs_createPlaneTubeConnector:
    def Activated(self):
        self.createPlaneTubeConnector()
    def createPlaneTubeConnector(self):
    ...
    def GetResources(self):
        ...
        _tooltip = ("")
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createPlaneTubeConnector"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createPlaneTubeConnector", Nurbs_createPlaneTubeConnector())
...
class Nurbs_createHelmetTubeConnector:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createHelmetTubeConnector"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createHelmetTubeConnector", Nurbs_createHelmetTubeConnector())
...
#        spb=[v.Point for v in fp.curveB.Shape.Vertexes]
        ...
        ptsa=[App.Vector(p) for  p in rcc[:-1]]
        ptsa += [App.Vector(p) for  p in rcc2]
...
class Nurbs_createTriangle:
    ...
    def GetResources(self):
        ...
        _tooltip = ("")
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createTriangle"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}

Gui.addCommand("Nurbs_createTriangle", Nurbs_createTriangle())
...
class Nurbs_SplitInToCells:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_SplitInToCells"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createTangentStripes:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createTangentStripes"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_CreateCELL:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateCELL"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_CreateQuadPlacement:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"alpha.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateQuadPlacement"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_FaceToBezierSurface:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_FaceToBezierSurface"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_Stretchandbend:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_Stretchandbend"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
def genbase(fp,pts,center=App.Vector(),offset=2):
    ...
    aa=genk(0,0,1,App.Vector(),sf,name=sf.Name,show=False)
    aa.ViewObject.hide()
    return aa,ptsa
...
def gencircle(fp,n,h=300,radius=400,center=None):
    ...
    ptsa=[App.Vector(p[0],p[1],h)+center for p in pts2]
    rot=fp.location.Rotation

    ptsa=[rot.multVec(App.Vector(p[0],p[1],h))+center for p in pts2]
...
class Nurbs_CreateSketchCircle:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateSketchCircle"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs_CreateSketchCircle", _tooltip)}
...
#        obj.addProperty("App::PropertyInteger","vWeight").vWeight=10
        ...
        obj.location.Base= App.Vector(6,12,3)
        obj.location.Rotation=App.Rotation(175,85,-180)
...
def createHole(fp,height=100):
    ...
    center=App.Vector((poles[0,0]+poles[-1,-1])*0.5)+App.Vector(2,-10,5)
...
#    Draft.makeWire([App.Vector(p) for p in pts])
...
class Nurbs_CreateHOLEGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateHOLEGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
#TODO Index of this code was wrong. Might fails -Mariwan
class Nurbs_createGordon:
    def Activated(self):
        self.createGordon()
    def createGordon(self,obj,scale=5.0):
        ...
        if obj.grid!=None:
            ...
            try:
                ...
                assert (App.Vector(polsu[-1,0]) - App.Vector(polsv[0,0])).Length<dista
...
#                            print ("i,j,self.blender",i,j,self.blender(j,v),self.blender(i,u))
        ...
        for ui,u in enumerate(uli):
            ...
            for i in range(suc+1):
                pts += [polsu[i]*self.blender(i,u)/self.blender(i,i)]
            ptsa=[App.Vector(p) for p in pts[0]]
            ptsarr += [ptsa]
...
#                False,False,3,3)
        ...
        for vi,v in enumerate(vli):
            ...
            for i in range(svc+1):
                pts += [polsv[i]*(self.blender(i,v)/self.blender(i,i))]
            ptsa=[App.Vector(p) for p in pts[0]]
            ptsarr2 += [ptsa]
...
class Nurbs_polishG1GUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_polishG1GUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createTangentHelpersGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"alpha.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createTangentHelpersGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_CreateBorderGUI:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"alpha.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateBorderGUI"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_createApprox:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'alpha.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_createApprox"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
def AA():
    ...
    drawcurveA(pts3,face,facepos=App.Vector())
...
class Nurbs_CreateSheelANDsolid:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateSheelANDsolid"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_FlattenTheWire:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_FlattenTheWire"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs_FlattenTheWire", _tooltip)}
