...
class Nurbs_AnalyseLoadTest1:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_AnalyseLoadTest1"),
...
class Nurbs_AnalyseLoadTest2:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_AnalyseLoadTest2"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_AnalyseTest4:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_AnalyseTest4"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_AnalyseTest3:
    ...
    def Test3(self):
        ...
        for i in range(1):
            ...
            fem=fem_edgelength_mesh.Nurbs_FemEdgeLengthMesh()
            fem.run()
            Gui.updateGui()
            print("i ")
            print(i)
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_AnalyseTest3"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
