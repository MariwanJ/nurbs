...
class newTestNeedleFunctionWasMain:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "newTestNeedleFunctionWasMain"),
...
class anotherNeedleCommandcalledRun:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "anotherNeedleCommandcalledRun"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_NeedleMain:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_NeedleMain"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
