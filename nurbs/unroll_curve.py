...
class Nurbs_UnrollCurve_yaw:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'YAW4.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_UnrollCurve_yaw"),
...
class Nurbs_UnrollCurve_pitch:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'YAW3.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_UnrollCurve_pitch"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
...
class Nurbs_UnrollCurve:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'YAW2.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_UnrollCurve"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
...
class Nurbs_unrollCurveMain:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'YAW1.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_unrollCurveMain"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
