...
class Nurbs_CreateQuadview:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspacequad.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateQuadview"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs_CreateQuadview", _tooltip)}
...
#        a.Proxy.v=v
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspace.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateH2"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs createH2", _tooltip)}
...
class Nurbs_CreateDarkRoom:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspace.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "NurbsCreateDarkRoom"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs CreateDarkRoom", _tooltip)}
...
class Nurbs_createlight:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspace2h.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbscreatelight"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs createlight", _tooltip)}
...
class Nurbs_LightON:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'light_on.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "NurbslightON"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs lightON", _tooltip)}
...
class Nurbs_LightOFF():
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'light_off.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_LightOFF"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs LightOFF", _tooltip)}
