...
class Nurbs_PointsRUNA:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"points.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_PointsRUNA"),
...
class Nurbs_PointsRUNC:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"points.svg"
,
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_PointsRUNC"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_PointsRUND:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"points.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_PointsRUND"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_PointsRUNE:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+"points.svg",
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_PointsRUNE"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
