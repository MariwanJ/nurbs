...
class Nurbs_ControlPanelAdd:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_ControlPanelAdd"),
...
class Nurbs_ControlPanelHU:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_ControlPanelHU"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_CreateGenericPanel:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_CreateGenericPanel"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs ", _tooltip)}
...
class Nurbs_ControlPanelCreateFunction:
    ...
    def GetResources(self):
        ...
        return {'Pixmap':  NURBSinit.ICONS_PATH + 'drawing.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_ControlPanelCreateFunction"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs", _tooltip)}
