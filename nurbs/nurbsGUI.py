...
class Nurbs_CreateWSLink:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspacelink.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "NurbsCreateWSLink"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs CreateWSLink", _tooltip)}
...
class Nurbs_CreateWorkspace:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'workspace.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "NurbsCreateWorkspace"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs CreateWorkspace", _tooltip)}
...
class Nurbs_main:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'drawing.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_main"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs  Nurbs_main", _tooltip)}
