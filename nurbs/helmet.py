...
#        print ("ptse23,",ptse2)
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_commandCreateHelmet"),
                'ToolTip': QT_TRANSLATE_NOOP("Nurbs Nurbs commandCreateHelmet", _tooltip)}
...
class Nurbs_HelmetCreateTriangle:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': NURBSinit.ICONS_PATH+'draw.svg',
                'MenuText': QT_TRANSLATE_NOOP("Nurbs", "Nurbs_HelmetCreateTriangle"),
